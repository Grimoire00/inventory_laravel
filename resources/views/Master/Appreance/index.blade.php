                        ...
                        <div class="form-group">
                            <div class="selectgroup selectgroup-pills d-flex justify-content-center">
                                <label class="selectgroup-item">
                                    @if ($data != '')
                                        <input type="radio" name="layout" value="sidebar-mini" class="selectgroup-input"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="selectgroup selectgroup-pills d-flex justify-content-center">
                                <label class="selectgroup-item">
                                    @if ($data != '')
                                        <input type="radio" name="theme" value="light-mode" class="selectgroup-input"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="selectgroup selectgroup-pills d-flex justify-content-center">
                                <label class="selectgroup-item">
                                    @if ($data != '')
                                        <input type="radio" name="menu" value="light-menu" class="selectgroup-input"
