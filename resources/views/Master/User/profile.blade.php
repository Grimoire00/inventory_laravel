    ...
    <div class="row mb-5">
        <div class="col-xl-4">
            <div class="card">
                ...
                <form action="{{ url('/admin/updatePassword') . '/' . $data->user_id }}" method="POST" name="myFormP"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="wrap-input100 validate-input input-group" id="Password-toggle">
                                ...
                                <input class="input100 form-control" value="{{ session()->get('currentpassword') }}"
                                    name="currentpassword" type="password" placeholder="Password Saat Ini">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="wrap-input100 validate-input input-group" id="Password-toggle1">
                                ...
                                <input class="input100 form-control" value="{{ session()->get('newpassword') }}"
                                    name="newpassword" type="password" placeholder="Password Baru">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="wrap-input100 validate-input input-group" id="Password-toggle2">
                                ...
                                <input class="input100 form-control" value="{{ session()->get('confirmpassword') }}"
                ...
                <form action="{{ url('/admin/updateProfile') . '/' . $data->user_id }}"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="nmlengkap" value="{{ $data->user_nmlengkap }}" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" value="{{ $data->user_email }}" class="form-control"
                                id="email" placeholder="Email">
                        </div>
                        <div class="form-group">
                            <label for="img">Foto</label>
                            <input class="form-control" id="GetFile" name="photoU" type="file"
